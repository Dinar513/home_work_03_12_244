...
def testgetmaskcardnumber() -> None:  # Добавлена аннотация возвращаемого типа
...
class Test_Get_Mask_Account(unittest.TestCase):  # Имя класса должно начинаться с заглавной буквы
    def test_normal_account(self) -> None:  # Добавлена аннотация возвращаемого типа
        """Тест нормального номера счета"""
        account_num = "73654108430135874305"
        expected = "4305"
        self.assertEqual(get_mask_account(account_num), expected)

    def test_short_account(self) -> None:  # Добавлена аннотация возвращаемого типа
        """Тест короткого номера счета"""
        account_num = "123"  # Меньше 20 символов
        with self.assertRaises(ValueError):
            get_mask_account(account_num)

    def test_empty_account(self) -> None:  # Добавлена аннотация возвращаемого типа
        """Тест пустой строки"""
        account_num = ""
        with self.assertRaises(ValueError):
            get_mask_account(account_num)

    def test_non_numeric_account(self) -> None:  # Добавлена аннотация возвращаемого типа
